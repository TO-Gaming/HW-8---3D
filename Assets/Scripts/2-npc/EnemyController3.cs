...
public class EnemyController3: MonoBehaviour {
    ...
    private void Update() {
        ...
        //float distanceToegine = Vector3.Distance(player.transform.position, engine.TargetObjectPosition());
        //Debug.Log("distanceToTarget = " + distanceToTarget);

        if (distanceToTarget <= radiusToWatch) {
            Chase();
        }
        /*else if (distanceToegine >= playerradiusfromengine)
        {
            Engine();
        }*/
